...
void read_input_parameters_c(int, char **, char *, char *, char *, long *, 
			   long *);
void print_help_c(void);
int svm_classify_main (int argc, char* argv[]);
...
int svm_classify_main (int argc, char* argv[])
{
  ...
  read_input_parameters_c(argc,argv,docfile,modelfile,predictionsfile,
...
void read_input_parameters_c(int argc, char **argv, char *docfile, 
