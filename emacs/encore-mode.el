...
(setq encore-keywords '("and" "await" "class" "chain" "consume" "def" "else" "eos" "get" "getNext" "if" "in" "let" "linear" "new" "not" "or" "passive" "print" "repeat" "stream" "suspend" "then" "this" "unless" "while" "yield" "async" "foreach"))
