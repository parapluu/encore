...
-- (Embed $ "void " ++ (A.cname cdecl) ++ "_dispatch(pony_actor_t* this, void* p, uint64_t id, int argc, pony_arg_t* argv) {}")
      ...
      pony_actor_t_impl = SEMI (Static (Assign (Embed $ "pony_actor_type_t " ++ pony_actor_t_name) (Record [(Embed "1"), --FIXME: this can't always be '1', needs to be different per actor.
                                                                                  tracefun_rec,
