...
/* newPar(int) -- primitives => deduce V int */
/* newPar(future_s*) -- future => deduce F future */
/* newPar(par_s*) -- par => based on previous type we can infer it */
/* newPar(void*) -- any pointer => deduce V pointer type */
