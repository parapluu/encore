...
{
  2,
  {trace, sizeof(updater_t), PONY_ACTOR},
  message_type,
  dispatch
};

static pony_msg_t m_create =
{
  6,
  {
    {NULL, 8, PONY_ACTOR},
    {array_actor_trace, 8, PONY_IMMUTABLE},
    {NULL, 8, PONY_PRIMITIVE},
    {NULL, 8, PONY_PRIMITIVE},
    {NULL, 8, PONY_PRIMITIVE},
    {NULL, 8, PONY_PRIMITIVE}
  }
...
static pony_msg_t m_apply = {1, {{NULL, 8, PONY_PRIMITIVE}}};
static pony_msg_t m_receive = {1, {{array_uint64_trace, 8, PONY_MUTABLE}}};
...
static void trace(void* p)
{
  ...
  // pony_trace64(&this->index);
  // pony_trace64(&this->size);
  // pony_trace64(&this->chunk);
  // pony_trace64(&this->rnd);
  // pony_trace64(&this->shift);
  // pony_trace64(&this->mask);
  pony_trace(&this->table, NULL, this->size * sizeof(uint64_t), PONY_MUTABLE);
}
