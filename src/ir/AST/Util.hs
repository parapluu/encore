...
putChildren [body] e@(Option {}) = e{body = body}
...
putChildren _ e@(Optional {}) = error "'putChildren l Option' expects l to have 0 element"
putChildren _ e@(Option {}) = error "'putChildren l Option' expects l to have 1 element"
